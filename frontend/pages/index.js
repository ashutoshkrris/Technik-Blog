        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 text-center">
              <h1 className="display-4 font-weight-bold">TECH BLOGS</h1>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 text-center pt-4 pb-5">
              <p className="lead">
                Best blogs related to technology, programming and development
              </p>
            </div>
          </div>
        </div>
        <center>
          <div className="col-md-4 align-center">
            <div className="flip flip-horizontal">
              ...
              >
                <h2 className="text-shadow text-center h1 pt-4 mt-4">Blogs</h2>
              </div>
              <div className="back text-center">
                <Link href="/blogs">
                  <a style={{ textDecoration: "none" }}>
                    <h3 className="h1 pt-4 mt-4">Blogs</h3>
                  </a>
                </Link>
                <p className="lead">Read all the blogs</p>
              </div>
            </div>
          </div>
        </center>
